...
const Menu = () => {
  ...
  rounded-t-xl sm:rounded-full py-3 px-6 flex items-center justify-around sm:justify-center gap-10 z-30"
    >
      <Link to="home" smooth>
      ...
      <Link to="skills" smooth>
        <Tooltip title="Skills" placement="top" arrow>
          <IconButton className="group">
            <LogoDevIcon className="text-white group-hover:text-secondary" />
          </IconButton>
        </Tooltip>
      </Link>
